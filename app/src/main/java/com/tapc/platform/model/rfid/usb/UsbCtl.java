package com.tapc.platform.model.rfid.usb;
...
import com.tapc.platform.library.uart.Commands;
import com.tapc.platform.library.uart.CommunicationPacket;
...
public class UsbCtl implements Observer {
    private static final String TAG = "UsbCtl";
            ...
            while (isUsbConnect()) {
                ...
                if (readcount > 0) {
                    ...
                    if (readcount == 1 && dataLength == 0x06) {
                        Log.e(TAG, "set baud rate success");
                        continue;
                    }
                    ...
                    if (retCount == (dataLength - 1) && retCount > 0) {
                        ...
                        BCC = (byte) ~BCC;
                        Log.e(TAG, "recv buf:" + bytesToHexString(usbdata));
                        ...
                        Log.e(TAG, "recv buf failed :" + bytesToHexString(pkgData));
                    }
                }
                SystemClock.sleep(10);
            }
            Log.e(TAG, "usb ReadThread close");
        }
    }
